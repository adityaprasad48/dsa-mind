...
// all divisior loop till sq of n
function divisiors(num) {
  for (let i = 1; i * i <= num; i++) {
    if (num % i == 0) {
      console.log("i divisiors", i);

      let second_div = Math.trunc(num / i);
      if (second_div !== i) console.log("second div", second_div);
    }
  }
}
